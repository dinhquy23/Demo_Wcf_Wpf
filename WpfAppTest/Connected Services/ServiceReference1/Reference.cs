...
namespace ServiceReference1
{
    ...
    public interface IService1
    {
        ...
        System.Threading.Tasks.Task<int> AdditionAsync(ServiceReference1.CompositeType composite);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<ServiceReference1.IService1>, ServiceReference1.IService1
    {
        ...
        public System.Threading.Tasks.Task<int> AdditionAsync(ServiceReference1.CompositeType composite)
        {
            return base.Channel.AdditionAsync(composite);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IService1))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:61001/Service1.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
